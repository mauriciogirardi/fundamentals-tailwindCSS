  ...
  return (
    <label
      className={twMerge(
        ...
        'hover:bg-violet-25 hover:border-violet-200 hover:text-violet-500 focus:border-violet-300 focus:ring-2 focus:ring-violet-100',
        'dark:border-zinc-600 dark:text-zinc-300 dark:hover:bg-zinc-800 dark:hover:text-violet-400',
      )}
      htmlFor={id}
    >
      <div className="border-6 rounded-full border-zinc-50 bg-zinc-100 p-2 group-hover:border-violet-50 dark:border-zinc-500 dark:bg-zinc-600 dark:group-hover:border-violet-400">
