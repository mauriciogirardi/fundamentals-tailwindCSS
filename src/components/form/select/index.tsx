    ...
    <SelectPrimitive.Root>
      ...
      <SelectPrimitive.Portal>
        <SelectPrimitive.Content
          ...
          position="popper"
          sideOffset={8}
          className="animate-slideDownAndFade z-10 max-h-[300px] w-[--radix-select-trigger-width] overflow-hidden rounded-lg border border-zinc-200 bg-white shadow-md dark:border-zinc-600 dark:bg-zinc-800"
        >
